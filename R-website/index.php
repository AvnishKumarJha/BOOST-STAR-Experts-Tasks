            ...
            <nav class="nav bd-container">
                ...
                <div class="nav__menu" id="nav-menu">
                    <ul class="nav__list">
                        ...
                        <li class="nav__item"><a href="form.php" class="nav__link">Log in</a></li>                        
                        <li class="nav__item">
            ...
            <section class="menu section bd-container" id="menu">
                ...
                <div class="menu__container bd-grid">
                    <div class="menu__content">
                        ...
                        <a class="button menu__button myBtn">
                    ...
                    <div class="menu__content">
                        ...
                        <a  class="button menu__button myBtn"><i class='bx bx-cart-alt'></i></a>
                    </div>
        ...
        <footer class="footer section bd-container">
            <div class="footer__container bd-grid">
                ...
                <div class="footer__content">
                    ...
                    <ul>
                        <li>IGNTU AMARKANTAK</li>
                        <li>Madhya prasesh, India</li>
                        <li>999 - 888 - 777</li>
            ...
            <p class="footer__copy">&#169; 2021 Sk creator studio. All right reserved</p>
        </footer>
